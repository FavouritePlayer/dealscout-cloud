...
Invoked by scraper_job.py (the CronJob/Job entrypoint), which writes the
result to the shared listings cache that /api/scan reads from — see
data/cache.py and ARCHITECTURE.md. The fixture in `playwright_loader.py`
backs tests only.
"""
import json
import logging
